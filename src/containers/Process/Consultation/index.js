...
import { CURRENT_PROCESS_CONSULTANT_1 } from "../../../helpers/constants";
import ModalEdit from "../ModalEdit";

export function Consultation({ intl, ...props }) {
  ...
  useEffect(() => {
    dispatch(getList({ type: CURRENT_PROCESS_CONSULTANT_1 }));
        ...
        {loading ? (
          ...
          <Content className="site-layout-background sale">
            <div className="d-flex justify-content-between">
              <span>
                Trang chủ > Cài Đặt > Cài đặt bán hàng > Cài đặt quy trình tư
                vấn
              </span>
            </div>
            <br />
            <p className="title-group">Cài đặt quy trình tư vấn</p>
                  ...
                  >
                    <div className="row">
                      <div className="col-md-12">
                        <Form.Item
                          name="type"
                          initialValue={CURRENT_PROCESS_CONSULTANT_1}
                          hidden={true}
                        ></Form.Item>
