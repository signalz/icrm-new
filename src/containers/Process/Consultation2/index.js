...
import { CURRENT_PROCESS_CONSULTANT_2 } from "../../../helpers/constants";
...
export function Consultation({ intl, ...props }) {
  ...
  useEffect(() => {
    dispatch(getList({ type: CURRENT_PROCESS_CONSULTANT_2 }));
                  ...
                  >
                    <div className="row">
                      <div className="col-md-12">
                        <Form.Item
                          name="type"
                          initialValue={CURRENT_PROCESS_CONSULTANT_2}
                          hidden={true}
                        ></Form.Item>
