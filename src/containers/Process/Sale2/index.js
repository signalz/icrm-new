...
import { CURRENT_PROCESS_SALE_2 } from "../../../helpers/constants";
...
export function Sale2({ intl, ...props }) {
  ...
  useEffect(() => {
    dispatch(getList({ type: CURRENT_PROCESS_SALE_2 }));
      ...
      <div style={{ padding: "0 24px 24px" }}>
        {loading ? (
          ...
          <Content className="site-layout-background sale">
            ...
            <br />
            <p className="title-group">Cài đặt quy trình bán hàng 2</p>
                  ...
                  >
                    <div className="row">
                      <div className="col-md-12">
                        <Form.Item
                          name="type"
                          initialValue={CURRENT_PROCESS_SALE_2}
                          hidden={true}
                        ></Form.Item>
