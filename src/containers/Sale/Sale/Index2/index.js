...
export function Sale2({intl, ...props}) {
  ...
  const dataSaleFetch = useSelector(state => state.saleSaleReducer.dataSale2Fetch);
  ...
  const [conditions, setConditions] = useState({
    ...
    end_created_at: '',
    campaign_id: '',
    process_type: CURRENT_PROCESS_SALE_2,
  });
  ...
  useEffect(() => {
    dispatch(getList2(conditions));
    return function cleanup() {
      dispatch(getList2Cleanup());
    }
  }, [conditions]);
        ...
        <Fragment>
          <Content className="site-layout-background customer consultant">
            <div className="d-flex justify-content-start">
              <span className="title">Trang chủ > Bán hàng > Quá trình bán hàng 2</span>
            </div>
            <div className="d-flex justify-content-between">
              <span className="title">Quá trình bán hàng 2</span>
...
export default injectIntl(Sale2);
